...
const initialConfig: ConfigState = {
  ...
  executionAdvanced: {
    timeout: EXECUTION_ENGINE_CONFIG.MAX_EXECUTION_TIME,
    ...
    enableSecurityChecks: EXECUTION_ENGINE_CONFIG.ENABLE_SECURITY_CHECKS,
    memoryLimit: EXECUTION_ENGINE_CONFIG.MAX_MEMORY_MB,
